                ...
                <div className="right-container-wrapper flex flex-col-reverse items-end">
                    <div className="right-container pl-4 overflow-auto">
                        <div className={'text-sm text-slate-400 font-light mb-10 p-0 mt-0' } id='intro'>
                            ...
                            <p className='mb-3'>Currently, my main focus is to deepen my knowledge and keep up with the latest trends in web development. I had been fortunate enough to work as an intern for a Textile Printing Company and also contribute to a Web Developer Startup while finishing my studies.</p>
                            <p className='mb-3'>Outside of work, I actively contribute to the FIVE:M development team and have started learning 3D modeling and animations. When I am not in front of the computer, you can find me enjoying the Danish weather on my bike, hanging out with my girlfriend, or playing Hearthstone for fun.</p>
                        </div>
