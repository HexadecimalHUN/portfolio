...
export default function Home() {
  return (
    <div>
        ...
        <div className="container mx-auto sm:max-w-lg md:max-w-xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-7xl">
            <div className="left-container top-1/3">
                ...
                <div className="link-container flex gap-5 mt-20">
                    <div className="github-link">
                        <a href="https://github.com/HexadecimalHUN" target='blank' rel="noopener noreferrer" className='w-10 h-10 text-slate-200'>
                        <FontAwesomeIcon icon={faGithub} className='w-10 h-10'/>
                        </a>
                    </div>
                    <div className="linkedin-link">
                        <a href="https://www.linkedin.com/in/peter-bodnar97/" target='blank' rel="noopener noreferrer" className='w-10 h-10 text-slate-200'>
            ...
            <div className="right-container-wrapper">
                <div className="right-container">
                    <div className={'text-sm text-slate-400 font-light mb-10 p-0 mt-0' }>
